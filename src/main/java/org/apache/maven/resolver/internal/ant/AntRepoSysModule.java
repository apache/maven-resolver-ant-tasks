...
@Named
public final class AntRepoSysModule
    extends AbstractModule
{
    ...
    protected void configure()
    {
        ...
        bind( MetadataGeneratorFactory.class ).annotatedWith( com.google.inject.name.Names.named( "snapshot" ) )
            .to( SnapshotMetadataGeneratorFactory.class ).in( Singleton.class );

        bind( MetadataGeneratorFactory.class ).annotatedWith( com.google.inject.name.Names.named( "versions" ) )
